...
import 'package:fixn_go/ui/screens/onboarding/onboarding3/onboarding3_view_model.dart';
import 'package:fixn_go/ui/widgets/onboardingwidgets.dart';

import 'package:flutter/material.dart';
import 'package:stacked/stacked.dart';

class OnboardingScreen3View extends StatelessWidget {
  const OnboardingScreen3View({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<OnboardingScreen3ViewModel>.reactive(
      viewModelBuilder: () => OnboardingScreen3ViewModel(),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// Image
                  OnboardingImage(image: Assets.images.onboarding3),
                  ...
                  const OnboardingSubtitle(
                    subtitle:
                        "Don't wait for days. Find professionals ready\nto work now and verify their quality with community reviews.",
                  ),
