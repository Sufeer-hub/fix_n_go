...
abstract class Palette {
  ...
  static Color onboardingyellow = Colors.yellow;
  static Color onboardinggrey = Colors.grey.shade300;
  static Color white = Colors.white;
  static Color blue = Color(0xFF1A56DB);
  static Color themecolor = Colors.orange;
  static const Color themecolorlight = Color(0xffffccbc);
}
